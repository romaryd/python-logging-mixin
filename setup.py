...
# installed yet)
version = re.search(
    "__version__ = '([^']+)'", text_of('loggingmixin/__init__.py')
).group(1)


NAME = 'python-logging-mixin'
VERSION = version
DESCRIPTION = 'Logging tools as Mixin'
KEYWORDS = 'logging'
AUTHOR = 'Romary Dupuis'
AUTHOR_EMAIL = 'romary@me.com'
URL = 'https://github.com/romaryd/python-logging-mixin'
